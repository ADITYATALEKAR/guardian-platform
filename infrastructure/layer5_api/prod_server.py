...
def build_layer5_wsgi_application_from_env() -> Callable[[Mapping[str, object], Callable[[str, list[tuple[str, str]]], object]], Iterable[bytes]]:
    ...
    return build_layer5_wsgi_application(
        Layer5BootstrapConfig(
            ...
            cycle_time_budget_seconds=_env_int("GUARDIAN_CYCLE_TIME_BUDGET_SECONDS", 900),
            discovery_category_a_time_budget_seconds=_env_int("GUARDIAN_CAT_A_BUDGET_SECONDS", 150),
            discovery_bcde_time_budget_seconds=_env_int("GUARDIAN_CAT_BCDE_BUDGET_SECONDS", 150),
            discovery_exploration_budget_seconds=_env_int("GUARDIAN_EXPLORATION_BUDGET_SECONDS", 150),
            discovery_exploitation_budget_seconds=_env_int("GUARDIAN_EXPLOITATION_BUDGET_SECONDS", 150),
        ),
